...
export default function Icons() {
    ...
    return(
        <div className={styles.icons_tools_animation} id={styles.position_icon}>
            ...
            <a href="https://www.linkedin.com/in/miguel-angel-nu%C3%B1ez-dominguez?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank"><FaLinkedin className={styles.only_icons}/></a>
            <a href="https://github.com/mikee210521" target="_blank"><FaGithub className={styles.only_icons}/></a>
        </div>
    )
}